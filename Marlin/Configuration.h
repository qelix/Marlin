...
#define STRING_CONFIG_H_AUTHOR "I did this" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet A8 with SKR Mini E3 v1.2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  35.29
    #define DEFAULT_Ki   3.14
    #define DEFAULT_Kd 99.03
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 295.0
  #define DEFAULT_bedKi 35.64
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.3, 99.0, 399, 102 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 5, -1.95 }
