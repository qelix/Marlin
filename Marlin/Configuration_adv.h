 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       1000 // It needs to power 2 motors in parallel, so roughly twice as much is fine
...
//#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
    #define LASER_POWER_INLINE // enabled because the stock config had it. Pretty sure I don't need it but wnted to make sure
